...
<td><?php echo $row["institute_address"]; ?></td>
                 ...
                 <!-- /. ROW  -->
               <a href="institute_photos.php?i_id=<?php echo $i_id; ?>" class=" btn btn-info btn">Add New </a><hr/>
...
<div align="center">
    ...
    <tr>
      ...
      <td>&nbsp;<a href="institute_photos_delete.php?ip_id=<?php echo $row['institute_photo_id'];?>&i_id=<?php echo $i_id; ?>"><img src="images/delete.jpg" width="60"height="60"></a></td>
    </tr>
	<?php
	}
	?>
