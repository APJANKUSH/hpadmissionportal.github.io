...
?>
                 ...
                 <!-- /. ROW  -->
               <a href="institute_courses.php"class=" btn btn-info btn">Add New </a><hr/>
    ...
    <tr>
      ...
      <td>&nbsp;<a href="institute_courses_edit.php?ic_id=<?php echo $row['institute_course_id'];?>"><img src="images/edit.png" width="60" height="60"></a></td>
      <td>&nbsp;<a href="institute_courses_delete.php?ic_id=<?php echo $row['institute_course_id'];?>"><img src="images/delete.jpg" width="60" height="60"></a></td>
    </tr>
	<?php
	}
	?>
