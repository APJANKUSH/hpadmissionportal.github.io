...
<script type="text/javascript" src="libraries/jquery.min.js"></script>
   ...
   <div class="login-div">
      ...
      <form id="login_form" action="">
         <input placeholder="Email" class="lemail" for="email ID" type="text" id="email_login" name="email">
         <p id="show_error_login_email"></p>
         <input placeholder="Password" class="nonull lpassword" for="password" type="password" id="password_login" name="password">
         <p id="show_error_login_pwd"></p>
         <button class="btn new_login_btn" type="submit" id="loginenter">Login</button><a class="forgot to-forgot link-change" href="https://collegedunia.com/auth/reset-password" _pageexpand_="104">Forgot my Password ?</a>
		    <br><br><p class="next-link">Not a Member Yet! <a class="link-change to-registration" href="" title="Sign Up" _pageexpand_="40">Join Us</a> it's Free.</p>
      </form>
   </div>
      </div>
