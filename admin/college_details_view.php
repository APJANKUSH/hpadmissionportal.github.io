        ...
        <div id="page-wrapper" >
            <div id="page-inner">
			 <div class="row">
                 ...
                 <!-- /. ROW  -->
               <a href="college_details.php" class=" btn btn-info btn">Add New </a><hr/>
                        ...
                        <div class="panel-heading">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
<tr>
        <th width="20" height="30" class="style3"><div align="center">
		...
		<th width="116" class="style3"><div align="center">Action</div></th>
        <th width="66" class="style3"><div align="center">Edit</div></th>
        <th width="61" class="style3"><div align="center">Delete</div></th>
      </tr>
	  </thead>
	  <tbody>
      <?php
	...
	?>
      <tr>
        ...
        <td class="style3">&nbsp;<img src="file/<?php echo $row['image']?>" width="100" height="100"/> <?php echo $row['college_name']?></td>
        ...
        <td class="style3">&nbsp;<a href="college_courses_view.php?c_id=<?php echo $row['college_id'];?>" class="btn btn-primary">View Course</a><br><a href="college_photos_view.php?c_id=<?php echo $row['college_id'];?>" class="btn btn-primary">View Photos</a><br><a href="college_applications.php?c_id=<?php echo $row['college_id'];?>" class="btn btn-primary">View Applications</a></td>
        ...
        <td class="style3">&nbsp;<a href="college_details_delete.php?c_id=<?php echo $row['college_id'];?>"><img src="images/delete.jpg" width="60" height="60"></a></td>
      </tr>
      <?php
	}
	?>
