			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                             Institute Photos<small>update</small>
                        </h1>
                    </div>
                </div> 
				<?php
...
<?php
    ...
    $row=mysql_fetch_array($res);
?>
<form action="institute_photos_update.php" method="post">
<input type="hidden"name="ip_id"value="<?php echo $row['institute_photo_id'];?>">
<input name="i_id" type="hidden" value="<?php echo $i_id; ?>">
  <div align="center">
    <p>Institue Photo</p>
    <table width="381" height="142" border="0">
      
      <tr>
        <td>Institute Photo</td>
        <td><input type="file" name="file"value="<?php echo $row['institute_photo']?>"class="form-control validate[required]"></td>
      </tr>
      <tr>
